...
const Campsite = ({backgroundImage, title, subtitle, 
  ...
  return(
    <section className={`h-full w-full min-w-[1100px] bg-cover
    ${backgroundImage} bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
...
const Camp = () => {
  return (
    <section className='xl:max-container mx-auto xl:rounded-3xl 
    relative flex flex-col max-w-screen py-10 lg:mb-10 lg:py-20 xl:mb-20'>
       <div className="hide-scrollbar flex h-[340px] lg:h-[400px] xl:h-[600px]
